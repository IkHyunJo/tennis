...
<table class="EntryBox marginauto">
	...
	<tr><td><h4>아이디</h4><center><input type="text" name="id" size="10" ></center></td>
	</tr>
	<tr><td><h4>패스워드</h4><center><input type="password" name="password" size="10"></center></td>
	</tr>
	<tr><h4><td align="center"><input type="submit" value="로그인"></h4></td>
	</tr>
	<br>
	</form>
</table>		
