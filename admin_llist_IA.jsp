...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class=" borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=일반부A1'">
				<td>일반부A1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=일반부A2'">
				<td>일반부A2</td>
			</tr>
