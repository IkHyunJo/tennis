               ...
               {               
				...
				<tr class="borderb tColor"><th width="40px">번</th><th class="borderl" width="150px">이름</th><th class="borderl" width="90px">점수</th><th class="borderl" width="70px">결과</th></tr><%
                  for(int j =0 ; j < 2 ; j++)
                  {
                     ...
                     {
                        if(j == 0){
                        %><tr class=" borderb"><td><%=j+1 %></td><td class="borderl"><%=M1Name.get(j)%><br><%=M2Name.get(j)%></td><td class="borderl"><%=T1Score.get(0) %></td>
                        <td rowspan="2" class="borderl"><%=Result.get(0)%></td></tr><%
                        }
                        else{
                        %><tr><td><%=j+1 %></td><td class="borderl"><%=M1Name.get(j)%><br><%=M2Name.get(j)%></td><td class="borderl"><%=T2Score.get(0) %></td>
                        </tr><%
                        }
                     }
                  }
               ...
               <tr class="tColor" ><th width="40px">번</th><th class="borderl" width="150px">이름</th><th class="borderl" width="90px">점수</th><th class="borderl" width="70px">결과</th></tr>	<%
                  for(int j = 0 ; j < 3 ; j++)
                  {
                     if(Group.equals(RsGroup.get(j)))
                     {
                        if(j == 0)
                        {
                           ...
                           else
                           {
                        	   if(MatchTeamKey1.get(1).equals(MatchTeamKey1.get(0)))
	                        	{
	   							%><tr class=""><td><%=j+1 %></td><td class=""><%=M1Name.get(0)%><br><%=M2Name.get(0)%></td><td class=""><%=T1Score.get(1)%></td>
    							</td>
	   							<td rowspan="2" class=""><%=Result.get(1)%></td></tr><%
	   							}
                        	   else
                               {
    								%><tr class=""><td><%=j+2 %></td><td class=""><%=M1Name.get(1)%><br><%=M2Name.get(1)%></td><td class=""><%=T1Score.get(1)%></td>
    							</td>
                        ...
                        {
                        %><tr><td><%=j+1 %></td><td class="borderl"><%=M1Name.get(j)%><br><%=M2Name.get(j)%></td><td class="borderl"><%=T2Score.get(1) %></td>
                        </tr><%
                        }
                     }
                  }
                     ...
                     if(Group.equals(RsGroup.get(j)))
                     {
                        if(j == 1){
                           ...
                           else
                           {
								...
								{
									%><tr class=""><td><%=j%></td><td class=""><%=M1Name.get(0)%><br><%=M2Name.get(0)%></td><td class=""><%=T1Score.get(2)%></td>
    								<td rowspan="2" class=""><%=Result.get(2)%></td></tr><%
								}
								else
								{
									%><tr class=""><td><%=j+1 %></td><td class=""><%=M1Name.get(1)%><br><%=M2Name.get(1)%></td><td class=""><%=T1Score.get(2)%></td>
    							<td rowspan="2" class=""><%=Result.get(2)%></td></tr><%
								}
                           }
                        }
                        else{
                        %><tr><td><%=j+1%></td><td class="borderl"><%=M1Name.get(j)%><br><%=M2Name.get(j)%></td><td class="borderl"><%=T2Score.get(2)%></td>
                        </tr><%
                        }
                     }
                  }
