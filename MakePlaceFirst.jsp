					...
					if(Woo.get(j).equals(String.valueOf(cnt))){
						if(!(Result.get(j).equals("경기전"))){
							...
							if(GroupName.equals(Group.get(j))){
								...
								ps4 = conn.prepareStatement("update place set onplaying=? where placekey=?");
								ps4.setString(1, "onplaying");
								ps4.setString(2, Placekey);
								ps4.executeUpdate();
