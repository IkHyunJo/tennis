...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=장년부A1'">
				<td>장년부A1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=장년부A2'">
				<td>장년부A2</td>
			</tr>
			</table>		
		</div>
