...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor borderb" onclick="javascript:window.location='admin_T_league.jsp?GroupName=단체전B1'">
				<td>단체전B1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_T_league.jsp?GroupName=단체전B2'">
				<td>단체전B2</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_T_league.jsp?GroupName=단체전B3'">
				<td>단체전B3</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_T_league.jsp?GroupName=단체전B4'">
				<td>단체전B4</td>
			</tr>
			</table>		
							<hr>
			...
			<td><a href="T_Entry_Bon.jsp"><img src="./img/mainentry.png" class="imgSize"></a></td>
			</tr>
			</table>
			</div>
		<hr>
