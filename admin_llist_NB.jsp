...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=노년부B1'">
				<td>노년부B1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=노년부B2'">
				<td>노년부B2</td>
			</tr>
			</table>		
		</div>
