...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class=" borderb" onclick="javascript:window.location='league.jsp?GroupName=노년부B1'">
				<td colspan="2">노년부B1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='league.jsp?GroupName=노년부B2'">
				<td colspan="2">노년부B2</td>
			</tr>
			</table>		
			<hr>	
				<div id="leaguefooter">
				...
				<td><a href="main_Entry.jsp?GroupName=노년부"><img src="./img/mainentry.png" class="imgSize"></a></td>
				</tr>
				</table>
				</div>
			<hr>			
