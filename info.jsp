...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor">
				<th colspan="3">사용안내</th>
			</tr>
			<tr class="tColor">
				<th colspan="3">목록</th>
			</tr>
			<tr>
				<td colspan="3"><a href="./info_gaein.jsp">개인전 사용 안내</a></td>
			</tr>
			<tr>
				<td colspan="3"><a href="./info_team.jsp">단체전 사용 안내</a></td>
			</tr>
			<tr>
				<td colspan="3"><a href="./info_search.jsp">검색 기능 사용 안내</a></td>
			</tr>
			</table>
				<hr>	
				<div id="leaguefooter">
				...
				<tr>
				<td><a href="index.jsp"><img src="./img/goback.png" class="imgSize"></a></td>
				</tr>
				</table>
				</div>
				<hr>
