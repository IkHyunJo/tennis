...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor borderb" onclick="javascript:window.location='league.jsp?GroupName=장년부A1'">
				<td colspan="2">장년부A1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='league.jsp?GroupName=장년부A2'">
				<td colspan="2">장년부A2</td>
			</tr>
			</table>	
			<hr>	
				<div id="leaguefooter">
				...
				<td><a href="main_Entry.jsp?GroupName=장년부A"><img src="./img/mainentry.png" class="imgSize"></a></td>
				</tr>
				</table>
				</div>
			<hr>				
