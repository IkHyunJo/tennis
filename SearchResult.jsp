...
<%
    ...
    %><tr class="tColor"><td colspan="2">[<%=Name %>] 검색 결과</td></tr></table><%
    while(rs.next())
    {
    ...
    {
	    %><tr onclick="javascript:window.location='SearchMatch.jsp?Name=<%=Name%>&Univ=<%=Univ.get(i)%>'">
	        <td><%=Name%></td><td><%=Univ.get(i)%> </td>
	    </tr></table><%
    }
...
%>
				...
				<div id="leaguefooter">
					<hr>
						<a href="llist.jsp"><img src="./img/goback.png"></a>
					<hr>
				</div>
		</div>
</div>
