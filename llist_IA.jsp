...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class=" borderb" onclick="javascript:window.location='league.jsp?GroupName=일반부A1'">
				<td colspan="2">일반부A1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='league.jsp?GroupName=일반부A2'">
				<td colspan="2">일반부A2</td>
			</tr>
			...
			<hr>	
				...
				<td><a href="main_Entry.jsp?GroupName=일반부A"><img src="./img/mainentry.png" class="imgSize"></a></td>
				</tr>
				</table>
				</div>
			<hr>			
