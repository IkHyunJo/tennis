...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor borderb" onclick="javascript:window.location='league.jsp?GroupName=일반부B1'">
				<td colspan="2">일반부B1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='league.jsp?GroupName=일반부B2'">
				<td colspan="2">일반부B2</td>
			</tr>
			<tr class="tColor borderb" onclick="javascript:window.location='league.jsp?GroupName=일반부B3'">
				<td colspan="2">일반부B3</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='league.jsp?GroupName=일반부B4'">
				<td colspan="">일반부B4</td>
			</tr>
			</table>	
			<hr>	
				...
				<td><a href="main_Entry.jsp?GroupName=일반부B"><img src="./img/mainentry.png" class="imgSize"></a></td>
				</tr>
				</table>
				</div>
			<hr>
