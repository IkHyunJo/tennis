...
<table class="table">
		...
		%>
			<form method="post" action = "MakeJoTest.jsp">
			<tr><th><%=Group%></th></tr>
			<tr><td>조 : <input type="text" name="jo" size="10"></td>
			</tr>
			<tr><td>멤버1 : <input type="text" name="m1" size="10"></td>
			</tr>
			<tr><td>멤버2 : <input type="text" name="m2" size="10"></td>
			</tr>
			<tr><td>그룹 : <input type="text" name="group" size="10" value="<%=Group%>"></td>
			</tr>
			<tr><td align="center"><input type="submit" value="입력"></td>
			</tr>
			<br>
			</form>
				<iframe src ="Jo_Table_Test.jsp" width = "1000px" height = "600px">
				</iframe>
​
			</table>		
		</div>
