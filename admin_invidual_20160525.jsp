...
<div id="rolling_box" class="rolling_box">
      ...
      <%
         ...
         String Jo_Number = request.getParameter("Jo_Number");
			...
			%><table class="EntryBox marginauto margintop20" width="350px"><tr class="tColor"><th><%=Group%></th></tr><tr><th><%=Jo_Number%>조 경기</th></tr></table>
			<%
         try{
                  ...
                  for(int j = 0 ; j < 3 ; j++)
                  {
                     if(Group.equals(RsGroup.get(j)))
                     {
                        if(j == 0){
                           ...
                           {
                           %><tr class=" borderb"><td><%=j+1 %></td><td class="borderl"><%=M1Name.get(j)%><br><%=M2Name.get(j)%><br>(<%=RsUniv.get(j)%>)</td><td class="borderl"><%=T1Score.get(1) %></td>
                           <td><select size = "1" name="Score1" style ="width:55px;">
                              <option name="Score1" vlaue ="0">0</option>
                              <option name="Score1" vlaue ="1">1</option>
                              <option name="Score1" vlaue ="2">2</option>
                  ...
                  for(int j =1 ; j < 3 ; j++)
                  {
                     if(Group.equals(RsGroup.get(j)))
                     {
                        if(j == 1){
                           ...
                           {
                        %><tr "><td><%=j+1%></td><td class="borderl"><%=M1Name.get(j)%><br><%=M2Name.get(j)%><br>(<%=RsUniv.get(j)%>)</td><td class="borderl"><%=T1Score.get(2) %></td>
                        <td><select size = "1" name="Score1" style ="width:55px;">
                              <option name="Score1" vlaue ="0">0</option>
                              <option name="Score1" vlaue ="1">1</option>
                              <option name="Score1" vlaue ="2">2</option>
                           ...
                           <td rowspan="2" class="borderl"><%=Result.get(2) %></td></tr><%
                           }
                        }
                        else{
