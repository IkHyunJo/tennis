...
<div id="rolling_box" class="rolling_box">
		...
		<%
			...
			try
			{
		         if(!(TeamKey1.length() <= 3 && TeamKey2.length() <= 3))
		         {
		            %><script type="text/javascript">
		            alert("아직 경기가 배정되지 않았습니다.");
		            </script>
				...
				rs = ps.executeQuery();
					while(rs.next())
					{		
						T1Score.add(rs.getString(6));
						T2Score.add(rs.getString(8));
					...
					<%
							...
							<form action="T_Entry_pass.jsp?entrykey=<%=entrykey%>&GroupName=<%=Group%>" method="post">
							<tr class="tColor">
							...
							<br><br>
							<table class="EntryBox marginauto">
							<form action="T_Entry_pass_detail.jsp?i=0&TeamKey1=<%=TeamKey1%>&TeamKey2=<%=TeamKey2%>&entrykey=<%=entrykey%>&GroupName=<%=Group%>" method="post">
							<tr class="tColor">
							...
							<br><br>
							<table class="EntryBox marginauto">
							<form action="T_Entry_pass_detail.jsp?i=1&TeamKey1=<%=TeamKey1%>&TeamKey2=<%=TeamKey2%>&entrykey=<%=entrykey%>&GroupName=<%=Group%>" method="post">
							<tr class="tColor">
								<th  width="150px">팀</th><th width="80px" colspan="2">SCORE</th><th width="120px">RESULT</th>
							</tr>
							<tr>
							...
							<br><br>
							<table class="EntryBox marginauto">
							<form action="T_Entry_pass_detail.jsp?i=2&TeamKey1=<%=TeamKey1%>&TeamKey2=<%=TeamKey2%>&entrykey=<%=entrykey%>&GroupName=<%=Group%>" method="post">
							<tr class="tColor">
								<th width="150px">팀</th><th width="80px" colspan="2">SCORE</th><th width="120px">RESULT</th>
							</tr>
							<tr>
		...
		<hr>
			...
			<tr>
			<td><a href="admin_T_main_Entry.jsp?GroupName=<%=Group%>"><img src="./img/goback.png" class="imgSize"></a></td>
			</tr>
			</table>
			</div>
		<hr>
