...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class=" " onclick="javascript:window.location='league.jsp?GroupName=청년부B1'">
				<td colspan="2">청년부B1</td>
			</tr>
			<tr class="" onclick="javascript:window.location='league.jsp?GroupName=청년부B2'">
				<td colspan="2">청년부B2</td>
			</tr>
			<tr class=" " onclick="javascript:window.location='league.jsp?GroupName=청년부B3'">
				<td colspan="2">청년부B3</td>
			</tr>
			<tr class="" onclick="javascript:window.location='league.jsp?GroupName=청년부B4'">
				<td colspan="2">청년부B4</td>
			</tr>
			</table>		
			<hr>	
				<div id="leaguefooter">
				...
				<td><a href="main_Entry.jsp?GroupName=청년부B"><img src="./img/mainentry.png" class="imgSize"></a></td>
				</tr>
				</table>
				</div>
			<hr>
