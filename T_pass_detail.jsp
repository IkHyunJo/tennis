			...
			if( yet == true ){
				...
				if(done == true){
					...
					if(i.equals("0")){
						...
						ps = conn.prepareStatement("update teammatch set m1t1s=? where matckey=?");
						ps.setString(1, Score1);
						ps.setString(2, MatchKey);
						ps.executeUpdate();
						
						ps = conn.prepareStatement("update teammatch set m1t2s=? where matckey=?");
						...
						ps = conn.prepareStatement("update teammatch set m2t1s=? where matckey=?");
						ps.setString(1, Score1);
						ps.setString(2, MatchKey);
						ps.executeUpdate();
						
						ps = conn.prepareStatement("update teammatch set m2t2s=? where matckey=?");
						ps.setString(1, Score2);
						ps.setString(2, MatchKey);
						ps.executeUpdate();
						...
						ps = conn.prepareStatement("update teammatch set m3t1s=? where matckey=?");
						ps.setString(1, Score1);
						ps.setString(2, MatchKey);
						ps.executeUpdate();
						
						ps = conn.prepareStatement("update teammatch set m3t2s=? where matckey=?");
						ps.setString(1, Score2);
						ps.setString(2, MatchKey);
						ps.executeUpdate();
