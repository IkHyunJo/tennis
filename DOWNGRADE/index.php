...
?
		<div class="setup_msg">APMSETUP? ????? ?? ?????.</div>
		<div class="info_msg">
			<p class="p_b10">?<u class="c_00"><?=$_SERVER["DOCUMENT_ROOT"]?></u> ????? ????? ???? ???? ????.</p>
			<p class="p_b10">??? ??? ?? ???? <u class="c_00"><?=$_SERVER["SCRIPT_FILENAME"]?></u> <font class="c_red">??? ??</font>? ??? ????.</p>
		</div>
?
		<table cellpadding="0" cellspacing="1" border="0" width="580" bgcolor="#d7d7d7" class="info_table">
		<tr>
		<td class="info_category">PHP ????</td>
		<td class="info_bg">[??????]<font class="c_00">\APM_Setup\php.ini</font></td>
		</tr>
		<tr>
		<td class="info_category">MySQL ????</td>
		<td class="info_bg">[??????]<font class="c_00">\APM_Setup\Server\MySQL5\data\my.ini</font></td>
		</tr>
		<tr>
		<td class="info_category">MySQL Data ?? ??</td>
		<td class="info_bg">[??????]<font class="c_00">\APM_Setup\Server\MySQL5\data</font></td>
		</tr>
		<tr>
		<td class="info_category">Apache ????</td>
		<td class="info_bg">[??????]<font class="c_00">\APM_Setup\Server\Apache\conf\httpd.conf </font></td>
		</tr>
		<tr>
		<td class="info_category">Apache ?? ??</td>
		<td class="info_bg">[??????]<font class="c_00">\APM_Setup\Server\Apache\logs </font></td>
		</tr>
		<tr>
