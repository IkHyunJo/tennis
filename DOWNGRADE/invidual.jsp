				...
				function open_in_frame(div) {
				   $('#my_frame').attr('src', div);
					...
					<div id ="numBtn">
							...
							<h4 class="floatL2"><button onclick='open_in_frame("https://docs.google.com/spreadsheets/d/1vc6HYjRw3KZaUt71exjG8PnWHyGDQrFpjwcBoAg6SOs/gviz/tq?tqx=out:html&tq=SELECT+B,C,D,E+WHERE+A+CONTAINS+3&gid=0")'>05</button></h4>
					</div>
				<ul class="mainmenu-ul">
				<li class="mainmenu-li"><h4>청년부A</h4><a href="#"></a>
				</li>
		...
		<div class="slidings"> 
			<div style="width:230px; height: 150px; position: relative; margin-top:40px;" id="promotionBanner" class="wrap" elementposition="0">
				<figure style="left:0; width:230px; position: absolute;" elementindex="0" elementposition="">
					<div id="R1">
					<div id="Entryh5">예선1</div>
						<table class="table3">
						<th colspan="5">COURT : 경북대학교</th>
							<tr>
								<th>그룹</th>
								<th>번호</th>
								<th>이름</th>
							...
							<tr>
								...
								조익현<br>
								(경북대)</td>
								<td>1vs3<br>10:15<br>L</td>
								<td>-</td>	
								<td>1vs2<br>0:15<br>L</td>
								<td>3</td>
							</tr>
							<tr>
								<td>2</td>
								...
								(경북대)</td>
								<td>-</td>					
								<td>2vs3<br>0:15<br>L</td>
								<td>2vs1<br>15:0<br>W</td>
								<td>2</td>
							</tr>
							<tr>
								<td>3</td>
								...
								조익현<br>
								(경북대)</td>		
								<td>3vs1<br>15:10<br>W</td>
								<td>3vs2<br>15:0<br>W</td>
								<td>-</td>	
								<td>1</td>
							</tr>
						</table>							
