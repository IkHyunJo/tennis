...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<th colspan="5">개인전</th>
				...
				ResultSet rs = null;
				String sql = "select * from pre_indiv";
				...
				try {
					...
					rs = ps.executeQuery();
					while(rs.next()){
						String PI_Number = rs.getString(1);
						String GroupName = rs.getString(2);
						%>
						
						<form method="post" name="form" action="receivetest.jsp">	
						<tr>
							<td><input type = "submit" class ="linkButton" name=Group value=<%=GroupName%>></td>
						</tr>
						</form>
						...
						<%
						System.out.println(PI_Number + "\t" + GroupName + "\t");
					}
					}catch(Exception e){
						e.printStackTrace();
					}
