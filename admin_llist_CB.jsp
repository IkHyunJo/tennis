...
<div id="rolling_box" class="rolling_box">
		<div id="R1">
			...
			<tr class="tColor borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=청년부B1'">
				<td>청년부B1</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=청년부B2'">
				<td>청년부B2</td>
			</tr>
			<tr class="tColor borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=청년부B3'">
				<td>청년부B3</td>
			</tr>
			<tr class="borderb" onclick="javascript:window.location='admin_league.jsp?GroupName=청년부B4'">
				<td>청년부B4</td>
			</tr>
			</table>
